 ...
 */
#define BOOST_TEST_MODULE algorithms.eclipser.linear_inequality
...
#pragma GCC diagnostic pop
  ...
  const auto result = fuzzuf::algorithm::eclipser::gray_concolic::linear_inequality::Find(
    ctx,
    triple
  );
  BOOST_CHECK( bool( result ) );

  BOOST_CHECK( bool( result->loose_inequality ) );
  BOOST_CHECK( bool( result->tight_inequality ) );

  BOOST_CHECK_EQUAL( result->loose_inequality->chunk_size, 1 );
  BOOST_CHECK( result->loose_inequality->endian == fuzzuf::algorithm::eclipser::Endian::BE );
  BOOST_CHECK_EQUAL( std::int64_t( result->loose_inequality->linearity.slope.denominator() ), 1 );
  BOOST_CHECK_EQUAL( std::int64_t( result->loose_inequality->linearity.slope.numerator() ), 2 );
  BOOST_CHECK_EQUAL( std::int64_t( result->loose_inequality->linearity.target ), 74 );
  BOOST_CHECK_EQUAL( std::int64_t( result->loose_inequality->linearity.x0 ), 48 );
  BOOST_CHECK_EQUAL( std::int64_t( result->loose_inequality->linearity.y0 ), 96 );
  BOOST_CHECK_EQUAL( result->loose_inequality->split_points.size(), 1 );
  BOOST_CHECK_EQUAL( std::int64_t( result->loose_inequality->split_points[ 0 ].first ), 36 );
  BOOST_CHECK_EQUAL( std::int64_t( result->loose_inequality->split_points[ 0 ].second ), 38 );
  BOOST_CHECK( result->sign == fuzzuf::algorithm::eclipser::Signedness::Signed );
  BOOST_CHECK_EQUAL( result->tight_inequality->chunk_size, 1 );
  BOOST_CHECK( result->tight_inequality->endian == fuzzuf::algorithm::eclipser::Endian::BE );
  BOOST_CHECK_EQUAL( std::int64_t( result->tight_inequality->linearity.slope.denominator() ), 1 );
  BOOST_CHECK_EQUAL( std::int64_t( result->tight_inequality->linearity.slope.numerator() ), 2 );
  BOOST_CHECK_EQUAL( std::int64_t( result->tight_inequality->linearity.target ), 74 );
  BOOST_CHECK_EQUAL( std::int64_t( result->tight_inequality->linearity.x0 ), 48 );
  BOOST_CHECK_EQUAL( std::int64_t( result->tight_inequality->linearity.y0 ), 96 );
  BOOST_CHECK_EQUAL( result->loose_inequality->split_points.size(), 1 );
  BOOST_CHECK_EQUAL( std::int64_t( result->tight_inequality->solutions[ 0 ] ), 37 );
