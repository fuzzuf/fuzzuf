 ...
 * just once.
 * @tparm I type of index of multi index container
 * @tparm F type of function to apply
 * @tparm If true, function is applied only on valid ( The value casted to bool
