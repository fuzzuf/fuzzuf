...
//  - A class member BaseProxyExecutor::proxy_path must hold the path to the proxy which is going to be executed
//  - A class member BaseProxyExecutor::pargv must hold the information required for an execution of the proxy (e.g. arguments)
//
// Responsibility (TODO):
