...
#include <memory>
#include "fuzzuf/algorithms/nautilus/fuzzer/nautilus_state.hpp"
...
class Nautilus : public Fuzzer {
public:
  explicit Nautilus(std::unique_ptr<NautilusState>&& state_ref);
  ~Nautilus();
