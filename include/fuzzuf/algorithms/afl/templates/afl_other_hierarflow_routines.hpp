...
template <class State>
NullableRef<HierarFlowCallee<void(void)>> CullQueueTemplate<State>::operator()(
    void) {
...
template <class State>
NullableRef<HierarFlowCallee<void(void)>> SelectSeedTemplate<State>::operator()(
    void) {
...
template <class State>
NullableRef<HierarFlowCallee<bool(const u8 *, u32)>>
