...
#ifndef FUZZUF_INCLUDE_ALGORITHMS_REZZUF_KSCHEDULER_ABANDON_ENTRY_HPP
#define FUZZUF_INCLUDE_ALGORITHMS_REZZUF_KSCHEDULER_ABANDON_ENTRY_HPP
...
struct AbandonEntry
 ...
 public:
  AbandonEntry(State &state) : state( state ) {}
