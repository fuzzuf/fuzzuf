 ...
 */ 
static constexpr std::array<double, AFLPLUSPLUS_NUM_CASE> AFLplusplusGetCaseWeights(
    bool has_extras,
    bool has_a_extras
) {
...
u32 AFLplusplusHavocCaseDistrib::CalcValue() {
    ...
    constexpr std::array<double, AFLPLUSPLUS_NUM_CASE> weight_set[2][2] = {
        { AFLplusplusGetCaseWeights(false, false), AFLplusplusGetCaseWeights(false, true) },
        { AFLplusplusGetCaseWeights(true,  false), AFLplusplusGetCaseWeights(true,  true) }
    };
...
// of CustomCases.
// Looking for a better way to achieve this...
