...
#include "fuzzuf/cli/fuzzer/mopt/build_mopt_fuzzer_from_args.hpp"
...
// a global variable and linked as an object file. Conversely, if MOpt cannot be
// built in a certain environment, do not compile it into an object file to
// prevent MOpt from being registered by accident.
static FuzzerBuilderRegister global_mopt_register(
    "mopt",
    BuildMOptFuzzerFromArgs<fuzzuf::fuzzer::Fuzzer, algorithm::mopt::MOptFuzzer,
